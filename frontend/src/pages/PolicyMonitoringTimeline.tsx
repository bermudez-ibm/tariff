      ...
      try {
        ...
        setEvents([
          ...
          },
          {
            ...
            title: 'Bangladesh GSP Eligibility Review Initiated',
            description: 'USTR announced formal review of Bangladesh Generalized System of Preferences eligibility due to labor compliance concerns. Potential suspension would eliminate duty-free treatment on $3.1M annual imports. Review period estimated 90-120 days.',
            severity: 'high',
            policy_type: 'Trade Agreement Review',
            impact: '$3.1M Impact'
          },
          {
            id: '4',
            ...
            title: 'Mexico USMCA Origin Verification Increase',
            description: 'Customs and Border Protection increased origin verification requests for USMCA claims by 40%. Enhanced scrutiny on yarn-forward rule compliance for textile imports. Expected to impact 28 SKUs with potential duty exposure if non-compliance identified.',
            severity: 'medium',
            policy_type: 'Compliance Requirements',
            impact: '$1.8M Risk'
          }
        ]);
        setError(null);
            ...
            {events.map((event) => (
              <div key={event.id} className="relative pb-10 last:pb-0">
                ...
                <div className="bg-slate-50 rounded-lg p-5">
                  ...
                  <div className="flex gap-3">
                    <Link to={`/alerts/${event.id}`} className="text-blue-700 font-medium text-[13px] flex items-center gap-1 hover:underline">
                      View Alert Details
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                      </svg>
                    </Link>
                    <Link to="/scenarios" className="text-blue-700 font-medium text-[13px] flex items-center gap-1 hover:underline">
